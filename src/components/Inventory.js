...
class Inventory extends React.Component {
  ...
  handleChange = (e, key) => {
      ...
      const updatedProperty = { ...fish, [e.target.name]: e.target.value }
      this.props.updateFish(key, updatedProperty);
  }
    ...
    const fish = this.props.fishes[key];
      return (
        <div key={key} className="fish-edit">
          ...
          <input value={fish.price} name="price" ref={input => this.price = input} type="text" placeholder="Fish Price"onChange={(e) => this.handleChange(e, key)} />
